...
<div class="modal fade" id="InputModal" aria-labelledby="InputModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ url('admin/country/save') }}" id="formCountry">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="saveCountry()" data-dismiss="modal" id="submitCountry" class="btn btn-primary">Save</button>
        </div>
      </form>
    </div>
  </div>
...
function loadList() {
    const page_url = '{{ url('admin/country/get-data') }}';
            ...
            { "data": null,"sortable": false,
                render: function (data, type, row, meta) {
                    var result = '<a class="btn btn-success btn-sm" \
                                    ...
                                    data-name = '+row.name+' \
                                    data-slug = '+row.slug+' \
                                onclick="editCountry(this)" data-toggle="modal" data-target="#InputModal"><i class="fa fa-pencil"></i> edit</a>&nbsp;';
...
function editCountry(e) {
  ...
  function saveCountry()
  {
    ...
    var url = "{{ url('admin/country/save') }}";

    if(name == ''){
          Swal.fire("Error!", "Name is required", "error");
       }else{
        // swalLoading();
           document.getElementById("submitCountry").disabled = true;
            ...
            $.ajax({
                ...
                success: function(result){
                    document.getElementById("submitCountry").disabled = false;
  ...
  {
    var url = "{{ url('admin/country/save_published') }}";
    ...
    function destroy(id){
        var url = "{{url('admin/country/destroy')}}"+"/"+id;
        Swal.fire({
            title: 'Are you sure?',
